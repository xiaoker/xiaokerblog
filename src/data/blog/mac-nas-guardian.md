...
MacBook 在 macOS 下有一套成熟的 SMC 温控机制。但装上 Linux 之后，这套机制就失效了。在 NAS 工况下——24 小时不间断读写、基本没有空闲——系统温度会悄无声息地爬到 80°C、90°C，风扇却还在以默认的低转速"躺平"。
...
这个项目目前主要面向：**旧款 Intel MacBook Pro + 飞牛 OS**。
